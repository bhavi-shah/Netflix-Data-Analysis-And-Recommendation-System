...
NetflixDF <-  read.csv(file = "C:/Users/Desktop/netflix/netflix_titles.csv", na.strings = c("NA", ""), stringsAsFactors=F)

##Fetch the weighted average votes/ratings of the movies from imdb for netflix

RatingsIMDB=fread("C:/Users/Desktop/netflix/IMDb ratings.csv", select = c("weighted_average_vote"))
TitlesIMDB=fread("C:/Users/Desktop/netflix/IMDb movies.csv", select = c('title','year','genre','reviews_from_users'))
